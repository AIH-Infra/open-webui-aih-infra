...
class ChatMessageTable:
    def upsert_message(
        ...
        with get_db_context(db) as db:
            ...
            usage_present = "usage" in data
            info_usage_present = (
                isinstance(data.get("info"), dict) and "usage" in data.get("info", {})
            )
            usage = data.get("usage")
            if not usage_present and info_usage_present:
            ...
            if existing:
                ...
                if usage_present or info_usage_present:

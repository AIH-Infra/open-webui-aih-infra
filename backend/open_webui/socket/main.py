    ...
    async def __event_emitter__(event_data):
        ...
        if (
            ...
            if event_type == "status":
                ...
                embeds = list(event_data.get("data", {}).get("embeds") or [])
                embeds.extend(message.get("embeds") or [])
                ...
                files = list(event_data.get("data", {}).get("files") or [])
                files.extend(message.get("files") or [])

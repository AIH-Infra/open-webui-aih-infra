        ...
        if response:
            ...
            for model in model_list:
                ...
                if prefix_id:
                    ...
                    prefixed_model_id = (
                        original_model_id
                        if original_model_id.startswith(f"{prefix_id}.")
                        else f"{prefix_id}.{original_model_id}"
                    )
                    model["id"] = prefixed_model_id

                    display_name_source = model.get("name") or original_model_id
                    model["name"] = (
                        display_name_source
                        if display_name_source.startswith(f"{prefix_id}.")
                        else f"{prefix_id}.{display_name_source}"
                    )
